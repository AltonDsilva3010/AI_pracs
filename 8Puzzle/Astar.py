...
class Node(object):
    ...
    def generate_nodes(self):
        zero_position = self.zero_position() #returns a tuple (1,1) position of the empty block to the variable zero_position.
        ...
        if zero_position[0] + 1 < 3: #checks if node can be moved downwards.
        ...
        if not zero_position[1] - 1 < 0: #check if node can be moved to the left
        ...
        if zero_position[1]+1<3: #checks if the node can be moved to the right
